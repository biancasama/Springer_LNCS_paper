...
\begin{itemize}
\item \emph{AntsReview}, which manages access management and the core system (See Figure \ref{fig:contracts} \textbf{a,b,f,h}).
\item \emph{Tokenomics}, which manages the incentive mechanism of the system (See Figure \ref{fig:contracts} \textbf{c,d,e,h}).
\item \emph{Privacy}, which maintains the pseudo-anonymity of the system via AZTEC Protocol (See Figure \ref{fig:contracts} \textbf{d}).
\end{itemize}
