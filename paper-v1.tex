...
\paragraph{Inclusiveness via gamification.} ll the community is involved in the process of peer-reviewing since there is no selection process ('open participation', 'open interaction', 'open platform');
