...
A thorny issue in the academic system that can be tackled by blockchain concerns the status and accreditation of peer-review, the core process of scientific validation currently facing a crisis \cite{Gropp-PeerRevStress}. 
...
\cite{Walsh200-openpeerrev} Of  the  referees  approached,  76%agreed to sign their name. This figure com-agreed to sign their name.
...
\cite{tragedy-reviewers} overburdened reviewer pool,we observe a progressive increase in journals without an increase in the number of reviewers.
suggestions for improvements are lost
