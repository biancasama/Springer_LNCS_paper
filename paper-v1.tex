...
\newline zkANTS will be implemented via AZTEC Protocol 2.0 (not yet released) that will allow to securely wrap the Ants-Review Token into zkANTS, allowing private transactions on mainnet and preserving the anonymity of Peer Reviewers.
